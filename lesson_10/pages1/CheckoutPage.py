...
class CheckoutPage(BasePage):
    ...
    @allure.step("Заполнение формы заказа личными данными покупатля "
                 "{first_name}, "
                 "{last_name}, "
                 "{postal_code}, "
                 "{continue}")
    def fill_checkout_form(self, first_name, last_name, postal_code):
        """
        Заполняет форму заказа личнми данными покупателя
        (имя, фамилия, почтовый код).
        Нажимает на кнопку "Продолжить".

        :param first_name: str — имя покупателя.
        :param last_name: str — фамилия покупателя.
        :param postal_code: int — номер почтового кода.
        """
    ...
    def get_total_price(self):
        ...
        :return: str - текст с итоговой стоимостью заказа.
        """
